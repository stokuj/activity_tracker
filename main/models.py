...
class Profile(models.Model):
    ...
    profileimg = models.ImageField(upload_to='profile_images', default='default_profile_image.jpg', blank=True)
...
class Followers(models.Model):
    followee = models.ForeignKey(User, on_delete=models.CASCADE, related_name='%(class)s_followee_created')
    follower = models.ForeignKey(User, on_delete=models.CASCADE, related_name='%(class)s_follower_created')
...
class Activity(models.Model):
    ...
    activity_duration = models.DurationField(default=timedelta, validators=[validate])
